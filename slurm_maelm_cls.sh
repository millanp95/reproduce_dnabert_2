...
CHECKPOINT_DIR="/scratch/m4safari/checkpoints/maelm_cls"
LOG_DIR="/scratch/m4safari/logs/maelm_cls"
...
# --- Training ---
# Architecture  : MAELM (6L/6H) + standard CLS token taxonomy head
# Pairs         : k=32 x m=2 -> 32 pos + 32 neg per batch
# Compile       : enabled (no dynamic shape issues without Jumbo)
