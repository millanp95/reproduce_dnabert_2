...
CHECKPOINT_DIR="/scratch/m4safari/checkpoints/bert_cls"
LOG_DIR="/scratch/m4safari/logs/bert_cls"
...
# --- Training ---
# Architecture : BERT-base (12L/12H) + standard CLS token taxonomy head
# Pairs         : k=32 x m=2 -> 32 pos + 32 neg per batch
# Compile       : enabled (no dynamic shape issues)
