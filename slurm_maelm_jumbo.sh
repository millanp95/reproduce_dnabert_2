...
CHECKPOINT_DIR="/scratch/m4safari/checkpoints/maelm_jumbo"
LOG_DIR="/scratch/m4safari/logs/maelm_jumbo"
...
# --- Training ---
# Architecture  : MAELM (6L/6H) + Jumbo CLS tokens + taxonomy head
